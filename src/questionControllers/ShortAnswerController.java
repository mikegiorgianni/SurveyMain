...
public class ShortAnswerController extends QuestionOps<ShortAnswer> {
    ...
    @Override
    public String displayQuestion( boolean withAnswers, ShortAnswer question) {
        StringBuilder sb = new StringBuilder("Short answer: " + question.getQuestion());
        if (withAnswers) sb.append(" : ").append(question.getAnswer());
        return sb.append("\n").toString();
    }
